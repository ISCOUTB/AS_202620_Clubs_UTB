...
|C2|Portabilidad|Equipo técnico|Se decide reemplazar el proveedor de base de datos/autenticación (Supabase por otra alternativa)|Módulo de acceso a datos / autenticación|Tiempo de diseño, antes de producción|El sistema se despliega en el nuevo entorno|El cambio de proveedor se limita al módulo de acceso a datos/auth; ≤ 2 módulos fuera de esa capa requieren modificación, verificable por revisión de la arquitectura de capas|
